          ...
          <div class="grid grid-cols-3 gap-4">
            <div class="col-span-1">
              <div class="block">
                ...
                <div class="grid mt-3">
                  <div class="flex truncate" v-if="presale.Website">
                  ...
                  <div class="flex truncate" v-if="presale.Telegram">
                  ...
                  <div class="flex truncate" v-if="presale.Twitter">
                    <svg class="h-6 w-6 text-gray-900 dark:text-white" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                  ...
                  <div class="flex truncate" v-if="presale.Medium">
                    <svg class="h-6 w-6 text-gray-900 dark:text-white" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                  ...
                  <div class="flex truncate"  v-if="presale.Github">
                    <svg class="h-6 w-6 text-gray-900 dark:text-white" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                  ...
                  <div>
                    ...
                    <div class="grid gap-1 mt-3">
                      <div class="flex">
                        ...
                        <span class="text-blue-500">{{ presale.Hardcap }}</span>
                    ...
                    <div class="grid gap-1 mt-1">
                      <div class="flex">
                        ...
                        <span class="text-blue-500">{{ presale.Softcap }}</span>
                        <span class="text-yellow-500 pl-2">BNB</span>
                      </div>
                    </div>
                    <div class="grid gap-1 mt-1">
                      <div class="flex">
                        ...
                        <span class="text-blue-500">{{ presale.TotalContributed }}</span>
                        <span class="text-yellow-500 pl-2">BNB</span>
                      </div>
                    </div>
                    <div class="grid gap-1 mt-1">
                      <div class="flex">
                        ...
                        <span class="text-blue-500">{{ presale.UserContribution }}</span>
                        <span class="text-yellow-500 pl-2">BNB</span>
                      </div>
                    </div>
                    <div class="grid gap-1 mt-1">
                      <div class="flex">
                        ...
                        <span class="text-blue-500">{{ presale.Roi }} </span>
